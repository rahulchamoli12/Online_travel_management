...
public interface PackageRepository extends JpaRepository<Package, Integer>{
	...
	@Query(value = "select h from hotel h where h.hotel_id IN (select ph.hotel_id from package_hotel ph where ph.package_id=:id group by ph.package_id) ",nativeQuery = true)
...
//	public List<Hotel> getAllHotels(@Param("id") Integer id);
	...
	public List<Hotel> getAvailableHotels(@Param("id") Integer id);
